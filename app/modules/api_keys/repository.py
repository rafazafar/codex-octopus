...
class ApiKeysRepository:
    ...
    async def update(
        ...
        *,
        ...
        if enforced_model_tiers is not _UNSET:
            assert enforced_model_tiers is None or isinstance(enforced_model_tiers, dict)
            row.enforced_model_tiers = enforced_model_tiers
