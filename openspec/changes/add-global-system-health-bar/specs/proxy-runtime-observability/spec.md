...
The dashboard backend SHALL expose a system-health summary that reports the highest-severity active cross-account risk condition derived from account availability and recent normalized request-log outcomes.
